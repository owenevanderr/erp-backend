...
__decorate([
    (0, common_1.Post)(':id/stock-in'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, products_dto_1.StockMovementDto]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "stockIn", null);
__decorate([
    (0, common_1.Post)(':id/stock-out'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, products_dto_1.StockMovementDto]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "stockOut", null);
